...
function Build-SDL3-FromSource {
    ...
    # Create comprehensive GameInput headers for CI builds
    Write-Log "Creating GameInput headers for CI builds"
    $gameinputHeader = Join-Path $srcDir.FullName 'src\core\windows\gameinput.h'
    $gameinputDir = Split-Path $gameinputHeader -Parent
    if (-not (Test-Path $gameinputDir)) {
        New-Item -ItemType Directory -Force -Path $gameinputDir | Out-Null
    }
    
    # Create a comprehensive gameinput.h that provides all SDL3 needs
    @"
#ifndef GAMEINPUT_H
#define GAMEINPUT_H

// Comprehensive GameInput header for CI builds
// This provides all the definitions SDL3 expects for GameInput support

#include <windows.h>

// GameInput device capabilities
#define GAMEINPUT_DEVICE_CAPABILITY_NONE                   0x00000000
#define GAMEINPUT_DEVICE_CAPABILITY_GAMEPAD                0x00000001
#define GAMEINPUT_DEVICE_CAPABILITY_KEYBOARD               0x00000002
#define GAMEINPUT_DEVICE_CAPABILITY_MOUSE                  0x00000004
#define GAMEINPUT_DEVICE_CAPABILITY_TOUCH                  0x00000008
#define GAMEINPUT_DEVICE_CAPABILITY_SENSOR                 0x00000010
#define GAMEINPUT_DEVICE_CAPABILITY_ARCADE_STICK           0x00000020
#define GAMEINPUT_DEVICE_CAPABILITY_BATTLESTICK            0x00000040
#define GAMEINPUT_DEVICE_CAPABILITY_FLIGHT_STICK           0x00000080
#define GAMEINPUT_DEVICE_CAPABILITY_GAMEPAD_WITH_TRIGGERS  0x00000100
#define GAMEINPUT_DEVICE_CAPABILITY_RACING_WHEEL           0x00000200
#define GAMEINPUT_DEVICE_CAPABILITY_UI_NAVIGATION          0x00000400

// GameInput reading types
#define GAMEINPUT_READING_NONE                             0x00000000
#define GAMEINPUT_READING_GAMEPAD                          0x00000001
#define GAMEINPUT_READING_KEYBOARD                         0x00000002
#define GAMEINPUT_READING_MOUSE                            0x00000004
#define GAMEINPUT_READING_TOUCH                            0x00000008
#define GAMEINPUT_READING_SENSOR                           0x00000010

// GameInput button states
#define GAMEINPUT_GAMEPAD_BUTTON_NONE                      0x00000000
#define GAMEINPUT_GAMEPAD_BUTTON_MENU                      0x00000001
#define GAMEINPUT_GAMEPAD_BUTTON_VIEW                      0x00000002
#define GAMEINPUT_GAMEPAD_BUTTON_A                         0x00000004
#define GAMEINPUT_GAMEPAD_BUTTON_B                         0x00000008
#define GAMEINPUT_GAMEPAD_BUTTON_X                         0x00000010
#define GAMEINPUT_GAMEPAD_BUTTON_Y                         0x00000020
#define GAMEINPUT_GAMEPAD_BUTTON_DPAD_UP                   0x00000040
#define GAMEINPUT_GAMEPAD_BUTTON_DPAD_DOWN                 0x00000080
#define GAMEINPUT_GAMEPAD_BUTTON_DPAD_LEFT                 0x00000100
#define GAMEINPUT_GAMEPAD_BUTTON_DPAD_RIGHT                0x00000200
#define GAMEINPUT_GAMEPAD_BUTTON_LEFT_SHOULDER             0x00000400
#define GAMEINPUT_GAMEPAD_BUTTON_RIGHT_SHOULDER            0x00000800
#define GAMEINPUT_GAMEPAD_BUTTON_LEFT_THUMBSTICK           0x00001000
#define GAMEINPUT_GAMEPAD_BUTTON_RIGHT_THUMBSTICK          0x00002000

// GameInput device info structure
typedef struct GAMEINPUT_DEVICE_INFO {
    UINT32 deviceId;
    UINT32 deviceCapabilities;
    UINT32 deviceCategory;
    UINT32 deviceFamily;
    UINT32 deviceVendorId;
    UINT32 deviceProductId;
    UINT32 deviceVersion;
    UINT32 deviceFirmwareVersion;
    UINT32 deviceHardwareVersion;
    UINT32 deviceSerialNumber;
    UINT32 deviceReportId;
    UINT32 deviceReportSize;
    UINT32 deviceReportCount;
    UINT32 deviceReportDescriptorSize;
    UINT32 deviceReportDescriptor[256];
} GAMEINPUT_DEVICE_INFO;

// GameInput reading structure
typedef struct GAMEINPUT_READING {
    UINT64 timestamp;
    UINT32 readingType;
    UINT32 deviceId;
    UINT32 sequenceId;
...
// GameInput function types (dummy implementations for CI)
typedef void* GAMEINPUT_DEVICE;
typedef void* GAMEINPUT_READING_LIST;

// Function declarations (dummy for CI)
GAMEINPUT_DEVICE GameInputCreateDevice(GAMEINPUT_DEVICE_INFO* deviceInfo);
void GameInputDestroyDevice(GAMEINPUT_DEVICE device);
GAMEINPUT_READING_LIST GameInputCreateReadingList();
void GameInputDestroyReadingList(GAMEINPUT_READING_LIST readingList);
BOOL GameInputGetCurrentReading(GAMEINPUT_DEVICE device, GAMEINPUT_READING_LIST readingList, GAMEINPUT_READING* reading);
BOOL GameInputGetNextReading(GAMEINPUT_READING_LIST readingList, GAMEINPUT_READING* reading);

#endif // GAMEINPUT_H
"@ | Set-Content -Path $gameinputHeader -Encoding UTF8
    Write-Log "Created comprehensive gameinput.h at $gameinputHeader"
